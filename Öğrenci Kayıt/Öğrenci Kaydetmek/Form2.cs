...
namespace Öğrenci_Kaydetmek
{
    public partial class Form2 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
             satir.SubItems.Add(((int)(DateTime.Now.Subtract(DateTime.Parse(satir.SubItems[3].Text)).TotalDays / 365)).ToString());
            }
            catch (Exception)
            {
            ...
            rastgele = new Random(Guid.NewGuid().GetHashCode()).Next(0, hastaliklar.Items.Count);
            satir.SubItems.Add(hastaliklar.Items[rastgele].ToString());

            listView1.TopItem = satir;
            ...
            if (_sqliteClass.insertRow("hastalar", yeniKayit.ToArray()))
            {
